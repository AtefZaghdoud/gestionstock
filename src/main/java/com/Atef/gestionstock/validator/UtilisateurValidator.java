...
public class UtilisateurValidator {
	public static List<String> validate(UtilisateurDto utilisateurDto){
		...
		if (org.springframework.util.StringUtils.hasLength(utilisateurDto.getNom())) {
			errors.add("Veuillez remplir le nom de l'utilisateur ");
			
		}
		if ( utilisateurDto == null || org.springframework.util.StringUtils.hasLength(utilisateurDto.getPrenom())) {
			errors.add("Veuillez remplir le prenom de l'utilisateur ");
			
		}
		if (org.springframework.util.StringUtils.hasLength(utilisateurDto.getEmail())) {
			errors.add("Veuillez remplir l'email de l'utilisateur ");
			
		}
		if ( utilisateurDto == null || org.springframework.util.StringUtils.hasLength(utilisateurDto.getMotDePasse())) {
			errors.add("Veuillez remplir le mot de passe de l'utilisateur ");
